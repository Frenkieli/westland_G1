...
let aboveText=document.querySelector('.demo_toparrow p');
let belowText=document.querySelector('.demo_bottom p');
let leftText=document.querySelector('.demo_leftarrow p');
let rightText=document.querySelector('.demo_rightarrow p');
...
function moveTop(e) {
    ...
    if(place==5){
        ...
        aboveText.innerHTML='';//改變方向文字
        belowText.innerHTML='往入口';
        leftText.innerHTML='往商店';
        rightText.innerHTML='往旋轉椅';
    }else
    if(place==4){
        ...
        aboveText.innerHTML='';//改變方向文字
        belowText.innerHTML='往海盜船';
        leftText.innerHTML='';
        rightText.innerHTML='往滑水道';
    }else
    if(place==6){
        ...
        aboveText.innerHTML='';//改變方向文字
        belowText.innerHTML='往雲霄飛車';
        leftText.innerHTML='往滑水道';
        rightText.innerHTML='';
    }else
    if(place==8){
        ...
        aboveText.innerHTML='往滑水道';//改變方向文字
        belowText.innerHTML='往摩天輪';
        leftText.innerHTML='往海盜船';
        rightText.innerHTML='往雲霄飛車';
    }else
    if(place==7){
        ...
        aboveText.innerHTML='往商店';//改變方向文字
        belowText.innerHTML='往旋轉木馬';
        leftText.innerHTML='';
        rightText.innerHTML='往入口';
    }else
    if(place==9){
        ...
        aboveText.innerHTML='往旋轉椅';//改變方向文字
        belowText.innerHTML='往出口';
        leftText.innerHTML='往入口';
        rightText.innerHTML='';
    }
};
...
function moveRight(e) {
    ...
    if (containerX >= -50) {
        ...
        if(place==8){
            ...
            aboveText.innerHTML='往雲霄飛車';//改變方向文字
            belowText.innerHTML='';
            leftText.innerHTML='往摩天輪';
            rightText.innerHTML='';
        }else
        if(place==7){
            ...
            aboveText.innerHTML='往入口';//改變方向文字
            belowText.innerHTML='';
            leftText.innerHTML='往旋轉木馬';
            rightText.innerHTML='往出口';
        }
    }
};
...
function moveLeft(e) {
    ...
    if (containerX <= -10) {
        ...
        if(place==8){
            ...
            aboveText.innerHTML='往海盜船';//改變方向文字
            belowText.innerHTML='';
            leftText.innerHTML='';
            rightText.innerHTML='往摩天輪';
        }
    }
};
