<?php
    ...
    $sql = "select a.leader_member_no , a.team_slogan ,a.team_bounty ,a.mascot_image as 'team_mascot_image' , c.member_name,b.image_source , b.mascot_image,a.team_name , b.bounty from team a left outer join ticket b on a.team_no=b.team_no left outer join members c on b.member_no = c.member_no order by a.team_bounty desc , b.bounty ,a.team_no DESC LIMIT 20";
